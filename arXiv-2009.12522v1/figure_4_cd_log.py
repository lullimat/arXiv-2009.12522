...
ax1.text(LX//2 + 30, LX//2 + 82, r'$\boldsymbol{E}^{(8)}_{P4,F6}$', color = 'red', fontsize = f_s)
...
ax1.plot([LX//2], [LX//2], 'o', color = 'black', markersize = 2)
ax1.text(LX - 55, LX//2 + 83, '$(C)$', fontsize = f_s)
...
ax2.text(LX//2 + 30, LX//2 + 82, r'$\boldsymbol{E}^{(8)}_{P2,F8}$', color = 'blue', fontsize = f_s)
...
ax2.plot([LX//2], [LX//2], 'o', color = 'black', markersize = 2)
ax2.text(LX - 55, LX//2 + 83, '$(D)$', fontsize = f_s)
...
plt.savefig(reproduced_figures / 'figure_4_cd_log.png',
