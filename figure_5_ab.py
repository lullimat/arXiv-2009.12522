...
ax1.text(_e_label_pos[0], _e_label_pos[1], r'$\boldsymbol{E}^{(6)}_{P4,F6}$',
...
ax2.text(_e_label_pos[0], _e_label_pos[1], r'$\boldsymbol{E}^{(6)}_{P2,F6}$', color = 'blue',
         transform = ax2.transAxes, fontsize = f_s)

ax2.text(_panel_label_pos[0], _panel_label_pos[1], '$(b)$', fontsize = f_s,
         transform = ax2.transAxes)

#ax2.text(_psi_label_pos[0], _psi_label_pos[1], '$\psi = \exp(-1/n),$', transform = ax2.transAxes, fontsize = f_s)
#ax2.text(_g_label_pos[0], _g_label_pos[1], '$Gc_s^2 = -3.6$', transform = ax2.transAxes, fontsize = f_s)
...
plt.savefig(reproduced_figures / 'figure_5_ab.png',
