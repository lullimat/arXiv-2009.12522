...
for _psi in [psis[0]]:
    for _stencil in [E10_P2F10_sym, E10_P4F6_sym]:
        _data_swap = ManageData(dump_file = laplace_files_E10[StencilPsiKey(_stencil, _psi)])
        _is_file_there = _data_swap.Read()
        if not _is_file_there:
            raise Exception("Could not find file!", 
                            laplace_files_E10[StencilPsiKey(_stencil, _psi)])        
...
UFields = {}
E_sym_dict = {E6_P2F6_sym: 'E6P2', E6_P4F6_sym: 'E6P4', E10_P2F10_sym: 'E10P2', E10_P4F6_sym: 'E10P4'}
...
plt.savefig(reproduced_figures / 'figure_5_ef.png',
