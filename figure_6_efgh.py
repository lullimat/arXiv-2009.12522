...
if True:
    ...
    if True:
        ...
        _y_ticks_swap = np.arange(0, axs[0, 0].get_ylim()[1], 0.005)
        ...
        axs[0, 0].text(_panel_label_pos[0], _panel_label_pos[1],
                       '$(e)$', transform = axs[0, 0].transAxes, fontsize = _fs)
        axs[0, 0].text(_g_label_pos[0], _g_label_pos[1],
                       '$\psi = 1 - \exp(-n), \quad Gc_s^2 = -1.75$', transform = axs[0, 0].transAxes, fontsize = _fs)        
    ...
    if True:
        ...
        axs[1, 0].text(_panel_label_pos[0], _panel_label_pos[1],
                       '$(f)$', transform = axs[1, 0].transAxes, fontsize = _fs)                
'''
G = -1.75
'''
if True:
    ...
    if True:
        ...
        _y_ticks_swap = np.arange(0, axs[0, 1].get_ylim()[1], 0.002)
        ...
        axs[0, 1].text(_panel_label_pos[0], _panel_label_pos[1],
                       '$(g)$', transform = axs[0, 1].transAxes, fontsize = _fs)
    ...
    if True:
        ...
        _y_ticks_swap = np.arange(0, axs[1, 1].get_ylim()[1] + 0.001, 0.002)
        axs[1, 1].set_yticks(_y_ticks_swap)
        axs[1, 1].set_ylim([axs[1, 1].get_ylim()[0], 0.0045])
        axs[1, 1].tick_params(axis="x", direction='in', length=8)
        axs[1, 1].text(_panel_label_pos[0], _panel_label_pos[1],
                       '$(h)$', transform = axs[1, 1].transAxes, fontsize = _fs)
        
reproduced_figures = Path("reproduced-figures")
        
plt.savefig(reproduced_figures / 'figure_6_efgh.png',
