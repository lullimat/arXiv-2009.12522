...
y_range = [0, 0.62]
f_s = 12
pos_c_label = (1.5e-4, 0.55)
pos_c_label0 = (1e-6, 0.55)
...
ax1.text(5e-7, 0.65, r'$\boldsymbol{E}^{(6)}_{P4,F6}$', color = 'red', fontsize = f_s)
ax1.text(1e-5, 0.65, r'$\boldsymbol{E}^{(6)}_{P2,F6}$', color = 'blue', fontsize = f_s)
...
ax1_1.text(1e-4, 0.65, r'$\boldsymbol{E}^{(8)}_{P4,F6}$', color = 'red', fontsize = f_s)
ax1_1.text(2e-3, 0.65, r'$\boldsymbol{E}^{(8)}_{P2,F8}$', color = 'blue', fontsize = f_s)
ax1_1.text(pos_c_label0[0], pos_c_label0[1], '$G c_s^2 = -3.6$', fontsize = f_s)
ax1_1.text(pos_label[0], pos_label[1], '$(b)$', fontsize = f_s)
...
plt.savefig(reproduced_figures / 'figure_7_ab.png',
