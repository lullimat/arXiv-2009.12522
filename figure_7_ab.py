...
ax1.text(5e-7, 0.65, r'$\bf{E}^{(6)}_{P4,F6}$', color = 'red', fontsize = f_s)
ax1.text(1e-5, 0.65, r'$\bf{E}^{(6)}_{P2,F6}$', color = 'blue', fontsize = f_s)
...
ax1_1.text(1e-4, 0.65, r'$\bf{E}^{(8)}_{P4,F6}$', color = 'red', fontsize = f_s)
ax1_1.text(2e-3, 0.65, r'$\bf{E}^{(8)}_{P2,F8}$', color = 'blue', fontsize = f_s)
