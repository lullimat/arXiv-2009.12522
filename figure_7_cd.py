...
y_range = [0, 0.65]
f_s = 12
pos_c_label = (1.5e-4, 0.585)
pos_c_label0 = (1e-6, 0.585)
pos_label = (0.7e-2, 0.585)
lw = 2.9
lw_c = 2
...
cumulative_iso = GetCumulative(u_bins = u_bins_iso_E10[G], logprob = logprob_iso_E10[G])
cumulative_niso = GetCumulative(u_bins = u_bins_niso_E10[G], logprob = logprob_niso_E10[G])

ax1.plot(np.exp(u_bins_iso_E10[G]), np.exp(logprob_iso_E10[G]), dashed[G], color = 'red',
         linewidth = lw)
ax1.plot(np.exp(u_bins_niso_E10[G]), np.exp(logprob_niso_E10[G]), dashed[G], color = 'blue')
...
ax1_bis.plot(np.exp(u_bins_iso_E10[G]), 1 - cumulative_iso, dashed[G], color = 'red', linewidth=0.7*lw_c)
ax1_bis.plot(np.exp(u_bins_niso_E10[G]), 1 - cumulative_niso, dashed[G], color = 'blue', linewidth=0.7)
...
ax1.text(pos_label[0], pos_label[1], '$(c)$', fontsize = f_s)
ax1.set_xscale('log')
...
cumulative_iso = GetCumulative(u_bins = u_bins_iso_E12[G], logprob = logprob_iso_E12[G])
cumulative_niso = GetCumulative(u_bins = u_bins_niso_E12[G], logprob = logprob_niso_E12[G])

ax1_1.plot(np.exp(u_bins_iso_E12[G]), np.exp(logprob_iso_E12[G]), dashed[G], color = 'red',
           linewidth = lw)
ax1_1.plot(np.exp(u_bins_niso_E12[G]), np.exp(logprob_niso_E12[G]), dashed[G], color = 'blue')
...
ax1_1_bis.plot(np.exp(u_bins_iso_E12[G]), 1 - cumulative_iso, dashed[G], color = 'red', linewidth=0.7*lw_c)
ax1_1_bis.plot(np.exp(u_bins_niso_E12[G]), 1 - cumulative_niso, dashed[G], color = 'blue', linewidth=0.7)
...
ax1_1.text(pos_label[0], pos_label[1], '$(d)$', fontsize = f_s)
...
plt.savefig(reproduced_figures / 'figure_7_cd.png',
